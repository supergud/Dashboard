...
<head>
    ...
    <title>5breakfast Dashboard</title>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="https://i.imgur.com/XXiXbii.png" class="user-image" alt="User Image">
                            <span class="hidden-xs">Alexander Pierce</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="https://i.imgur.com/XXiXbii.png" class="img-circle" alt="User Image">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href=""><i class="fa fa-book"></i> <span>商家數據</span></a></li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="treeview">
                            <a href="#"><i class="fa fa-bar-chart"></i>分析
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-calendar-o"></i>事件觸發</a></li>
                                <li><a href="#"><i class="fa fa-sticky-note-o"></i>例外訊息</a></li>
                                <li><a href="#"><i class="fa fa-user-plus"></i>好友成長</a></li>
                                <li><a href="#"><i class="fa fa-paper-plane"></i>主動推播品質</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
